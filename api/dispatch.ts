...
function getBearerTokenFromHeaders(headers: AnyObj): string | null {
...
/**
 * Vercel Node.js Serverless Function (API Route)
 *
 * POST /api/dispatch
 *
 * Headers:
...
export default async function handler(req: any, res: any) {
  try {
    ...
    const userOmApiKey = getBearerTokenFromHeaders(req.headers || {});
    if (!userOmApiKey) {
    ...
    // Avoid FUNCTION_INVOCATION_FAILED by always returning JSON.
    return sendJson(res, 500, {
